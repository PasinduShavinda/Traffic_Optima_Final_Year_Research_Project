...
------------------------------------------------------------------------------
 File: Lane01.py
 Purpose: This file contains a functions vechicle count detection for lane01
 Author: IT20137700
 Date: 2023-10-30
------------------------------------------------------------------------------
"""
...
def Lane01_detection(video_path):
    ...
    line_cx_upper = int(80 * scaling_fraction)
    line_cx_lower = int(3000 * scaling_fraction)
