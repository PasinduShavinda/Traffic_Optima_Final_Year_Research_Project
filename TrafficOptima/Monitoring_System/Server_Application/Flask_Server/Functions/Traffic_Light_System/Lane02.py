...
------------------------------------------------------------------------------
 File: Lane02.py
 Purpose: This file contains a functions vechicle count detection for lane02
 Author: IT20137700
 Date: 2023-10-30
------------------------------------------------------------------------------
"""
...
def Lane02_detection(video_path):
    ...
    line_cx_upper = int(200 * scaling_fraction)
    line_cx_lower = int(1000 * scaling_fraction)
