"""
------------------------------------------------------------------------------
 File: speed_detecting.py
 Purpose: This file contains a script for capture Speed of moving object.
 Author: IT20122614
 Date: 2023-10-30
------------------------------------------------------------------------------
"""
import cv2
import numpy as np
from TrafficOptima.Monitoring_System.Server_Application.Flask_Server.Functions.Violation_Detection.Speed_Tracking.SpeedTracker import *
